    ...
    return (
        <html lang="en">
            ...
            <body className={`accent-background p-4 text-gray-900`}>
                <a href="https://github.com/cbrown987/cs191capstone" className="github-corner" aria-label="View source on GitHub">
                    <svg width="80" height="80" viewBox="0 0 250 250" 
                         style={{fill: '#902425', color: '#fff', position: 'absolute', top: 0, border: 0, right: 0}}
                         aria-hidden="true">
